...
# with command line options: MadGraph_matching_cfi.py --filein=file:fourtop1000_v4.lhe -s GEN,FASTSIM,HLT:GRun --pileup=FlatDist10_2011EarlyData_50ns --conditions START42_V11::All --beamspot Realistic7TeVCollision --eventcontent=RECOSIM --datatier GEN-SIM-DIGI-RECO -n 10000 --no_exec
...
process.source = cms.Source("LHESource",
    fileNames = cms.untracked.vstring('file:/eos/uscms/store/user/algomez/FourTop/Generator/lhe/fourtop700_10k_1.lhe')
)
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('MadGraph_matching_cfi.py nevts:10000'),
...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    #fileName = cms.untracked.string('MadGraph_matching_cfi_py_GEN_FASTSIM_HLT_PU.root'),
    fileName = cms.untracked.string('file:tttt_Gh700_pythia6.root'),
