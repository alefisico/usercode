...
if not options.useData :
    ...
    if options.use41x:
        process.source.fileNames = [
 	    'file:/eos/uscms/store/user/algomez/FourTop/Generator/tttt_Gh700.root',
            ]
    else :
	if not options.useSusyFilter :
		process.source.fileNames = [
 '/store/user/algomez/tttt_Gh700_50k_FASTSIM/tttt_Gh700_50k_FASTSIM/a7de9108a52ac58f1a54f1937fca7ff9/tttt_Gh700_50k_FASTSIM_10_1_T7u.root',
  '/store/user/algomez/tttt_Gh700_50k_FASTSIM/tttt_Gh700_50k_FASTSIM/a7de9108a52ac58f1a54f1937fca7ff9/tttt_Gh700_50k_FASTSIM_11_1_poi.root',
  '/store/user/algomez/tttt_Gh700_50k_FASTSIM/tttt_Gh700_50k_FASTSIM/a7de9108a52ac58f1a54f1937fca7ff9/tttt_Gh700_50k_FASTSIM_13_1_Toe.root',
  '/store/user/algomez/tttt_Gh700_50k_FASTSIM/tttt_Gh700_50k_FASTSIM/a7de9108a52ac58f1a54f1937fca7ff9/tttt_Gh700_50k_FASTSIM_12_2_88A.root',
  '/store/user/algomez/tttt_Gh700_50k_FASTSIM/tttt_Gh700_50k_FASTSIM/a7de9108a52ac58f1a54f1937fca7ff9/tttt_Gh700_50k_FASTSIM_14_1_zMh.root',
  '/store/user/algomez/tttt_Gh700_50k_FASTSIM/tttt_Gh700_50k_FASTSIM/a7de9108a52ac58f1a54f1937fca7ff9/tttt_Gh700_50k_FASTSIM_15_1_G7T.root',
  '/store/user/algomez/tttt_Gh700_50k_FASTSIM/tttt_Gh700_50k_FASTSIM/a7de9108a52ac58f1a54f1937fca7ff9/tttt_Gh700_50k_FASTSIM_16_1_spY.root',
  '/store/user/algomez/tttt_Gh700_50k_FASTSIM/tttt_Gh700_50k_FASTSIM/a7de9108a52ac58f1a54f1937fca7ff9/tttt_Gh700_50k_FASTSIM_17_1_Aaw.root',
  '/store/user/algomez/tttt_Gh700_50k_FASTSIM/tttt_Gh700_50k_FASTSIM/a7de9108a52ac58f1a54f1937fca7ff9/tttt_Gh700_50k_FASTSIM_18_1_5bd.root',
  '/store/user/algomez/tttt_Gh700_50k_FASTSIM/tttt_Gh700_50k_FASTSIM/a7de9108a52ac58f1a54f1937fca7ff9/tttt_Gh700_50k_FASTSIM_19_1_7Xl.root',
  '/store/user/algomez/tttt_Gh700_50k_FASTSIM/tttt_Gh700_50k_FASTSIM/a7de9108a52ac58f1a54f1937fca7ff9/tttt_Gh700_50k_FASTSIM_1_1_rHo.root',
  '/store/user/algomez/tttt_Gh700_50k_FASTSIM/tttt_Gh700_50k_FASTSIM/a7de9108a52ac58f1a54f1937fca7ff9/tttt_Gh700_50k_FASTSIM_20_1_E1C.root',
  '/store/user/algomez/tttt_Gh700_50k_FASTSIM/tttt_Gh700_50k_FASTSIM/a7de9108a52ac58f1a54f1937fca7ff9/tttt_Gh700_50k_FASTSIM_21_1_Oak.root'
			]
	else :
		process.source.fileNames = [
	 	    'file:/eos/uscms/store/user/algomez/FourTop/Generator/tttt_Gh700.root',
    ...
    if options.use41x :
        ...
        process.source.fileNames = [
 	    'file:/uscms_data/d3/algomez/files/tttt_Gh_Gh_Gh/Generation/tttt_Gh700.root',
            ]
    else :
        inputJetCorrLabel = ('AK5PFchs', ['L1FastJet', 'L2Relative', 'L3Absolute', 'L2L3Residual'])
        process.source.fileNames = [
...
if options.useData :
    if options.writeFat :
        process.out.fileName = cms.untracked.string('tttt_Gh700_' + fileTag + '_data_fat.root')
    else :
        process.out.fileName = cms.untracked.string('tttt_Gh700_' + fileTag + '_data.root')
else :
    if options.writeFat :
        process.out.fileName = cms.untracked.string('tttt_Gh700_' + fileTag + '_mc_fat.root')
    else :
        process.out.fileName = cms.untracked.string('file:/eos/uscms/store/user/algomez/FourTop/Ntuples/tttt_Gh700_50k_1_' + fileTag + '_mc.root')
