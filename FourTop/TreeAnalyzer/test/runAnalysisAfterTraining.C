...
void runAnalysisAfterTraining(TString sample="all",bool NoGUI=false, bool getLogs=false) 
{
  ...
  if (sample=="MC"||sample=="4Top_1000"||sample=="all")
    {
      ...
      mc_4Top_1000->Add("/uscms_data/d3/algomez/files/fourtop/Ntuples/4Top_1000_Tuple-PATskim.root");
      mc_4Top_1000->Process("AnalyzerAfterTraining.C+","sample=4Top_1000");
    }
 /* 
  if (NoGUI) p->SetBit(TProof::kUsingSessionGui);
  if (sample=="MC"||sample=="4Top_500"||sample=="all")
    {
      ...
      mc_4Top_500->Add("/uscms_data/d3/algomez/files/fourtop/Ntuples/4Top_500_Tuple-PATskim.root");
      mc_4Top_500->Process("AnalyzerAfterTraining.C+","sample=4Top_500");
    }
*/
  if (NoGUI) p->SetBit(TProof::kUsingSessionGui);
  if (sample=="MC"||sample=="ttbar"||sample=="all")
    {
      ...
      mc_ttbar->Process("AnalyzerAfterTraining.C+","sample=ttbar");
    }
/*
  if (NoGUI) p->SetBit(TProof::kUsingSessionGui);
  if (sample=="ttbarM"||sample=="all")
    {
      ...
      mc_ttbarm->Process("AnalyzerAfterTraining.C+","sample=ttbarMatchup");
    }
  if (NoGUI) p->SetBit(TProof::kUsingSessionGui);
  ...
  if (sample=="ttbarM"||sample=="all")
    {
      ...
      mc_ttbarm->Process("AnalyzerAfterTraining.C+","sample=ttbarMatchdown");
    }
  if (NoGUI) p->SetBit(TProof::kUsingSessionGui);
  ...
  if (sample=="ttbarQ"||sample=="all")
    {
      ...
      mc_ttbarm->Process("AnalyzerAfterTraining.C+","sample=ttbarScaleup");
    }
  if (NoGUI) p->SetBit(TProof::kUsingSessionGui);
  ...
  if (sample=="ttbarQ"||sample=="all")
    {
      ...
      mc_ttbarm->Process("AnalyzerAfterTraining.C+","sample=ttbarScaledown");
    }
*/
  ...
  if (sample=="MC"||sample=="WJets"||sample=="all")
    {
      ...
      mc_Wjets->Process("AnalyzerAfterTraining.C+","sample=WJets");
    }
  if (NoGUI) p->SetBit(TProof::kUsingSessionGui);
  if (sample=="MC"||sample=="QCD"||sample=="all")
    {
      ...
      mc_QCD->Process("AnalyzerAfterTraining.C+","sample=QCD");
    }
  if (NoGUI) p->SetBit(TProof::kUsingSessionGui);
  if (sample=="MC"||sample=="STsch"||sample=="all")
    {
      ...
      mc_STsch->Process("AnalyzerAfterTraining.C+","sample=STsch");
    }
  if (NoGUI) p->SetBit(TProof::kUsingSessionGui);
  if (sample=="MC"||sample=="STtch"||sample=="all")
    {
      ...
      mc_STtch->Process("AnalyzerAfterTraining.C+","sample=STtch");
    }
  if (NoGUI) p->SetBit(TProof::kUsingSessionGui);
  if (sample=="MC"||sample=="STtWch"||sample=="all")
    {
      ...
      mc_STtWch->Process("AnalyzerAfterTraining.C+","sample=STtWch");
    }
  if (NoGUI) p->SetBit(TProof::kUsingSessionGui);
  if (sample=="MC"||sample=="STsch_bar"||sample=="all")
    {
      ...
      mc_STsch_bar->Process("AnalyzerAfterTraining.C+","sample=STsch_bar");
    }
  if (NoGUI) p->SetBit(TProof::kUsingSessionGui);
  if (sample=="MC"||sample=="STtch_bar"||sample=="all")
    {
      ...
      mc_STtch_bar->Process("AnalyzerAfterTraining.C+","sample=STtch_bar");
    }
  if (NoGUI) p->SetBit(TProof::kUsingSessionGui);
  if (sample=="MC"||sample=="STtWch_bar"||sample=="all")
    {
      ...
      mc_STtWch_bar->Process("AnalyzerAfterTraining.C+","sample=STtWch_bar");
    }
  if (NoGUI) p->SetBit(TProof::kUsingSessionGui);
  if (sample=="MC"||sample=="WW"||sample=="all")
    {
      ...
      mc_WW->Process("AnalyzerAfterTraining.C+","sample=WW");
    }
  if (NoGUI) p->SetBit(TProof::kUsingSessionGui);
  if (sample=="MC"||sample=="WZ"||sample=="all")
    {
      ...
      mc_WZ->Process("AnalyzerAfterTraining.C+","sample=WZ");
    }
  if (NoGUI) p->SetBit(TProof::kUsingSessionGui);
  if (sample=="MC"||sample=="ZJets"||sample=="all")
    {
      ...
      mc_ZJets->Process("AnalyzerAfterTraining.C+","sample=ZJets");
    } 
  /*
  if (NoGUI) p->SetBit(TProof::kUsingSessionGui);
  ...
  if (sample=="MCsyst"||sample=="WJetsScaleUp"||sample=="all")
    {
      ...
      mc_WJets_scaleup->Process("AnalyzerAfterTraining.C+","sample=WJets_scaleup");
    }
  if (NoGUI) p->SetBit(TProof::kUsingSessionGui);
  if (sample=="MCsyst"||sample=="WJetsScaleDown"||sample=="all")
    {
      ...
      mc_WJets_scaledown->Process("AnalyzerAfterTraining.C+","sample=WJets_scaledown");
    }
  */
  if (NoGUI) p->SetBit(TProof::kUsingSessionGui);
  ...
  if (sample=="data"||sample=="all")
    {
      ...
      data->Process("AnalyzerAfterTraining.C+","sample=data");
      // get log files
      if (getLogs)
	{
  ...
  if (sample=="dataQCD2"||sample=="all")
    {
      ...
      dataQCD2->Process("AnalyzerAfterTraining.C+","QCD2 sample=data");
    }
