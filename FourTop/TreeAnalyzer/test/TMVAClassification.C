// @(#)root/tmva $Id: TMVAClassification.C,v 1.1 2011/12/16 14:26:35 kalanand Exp $
/**********************************************************************************
...
void TMVAClassification( TString myMethodList = "" ) 
{
   ...
   //factory->AddVariable("bdisc_5th", 'F');
   //factory->AddVariable("bdisc_6th", 'F');
   //factory->AddVariable("bdisc_7th", 'F');
...
//    TCut mycutb = "abs(eta)>1.5"; // for example: TCut mycutb = "abs(var1)<0.5";
  ...
  //TCut mycuts ("evtNJ==2");
  TCut mycuts ("bdisc_1st>0 && bdisc_1st<1 && bdisc_2nd>0 && bdisc_2nd <1 && bdisc_3rd>0 && bdisc_3rd <1");
