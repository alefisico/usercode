...
set Sample_Dir = ${Main_Dir}/${results}_Nbjets3${version}/
...
def get_model():
    ...
    model = build_model_from_rootfile('/uscms/home/algomez/nobackup/files/fourtop/resultsTreeAnalyzer/${results}/Nbjets3/mu_stjet_templates.root', include_mc_uncertainties = True)
...
#plot_exp.write_txt('bayesian_limits_expected_stjet'+points[0][0]+'_${version}.txt')
#plot_obs.write_txt('bayesian_limits_observed_stjet'+points[0][0]+'_${version}.txt')
plot_exp.write_txt('cls_limits_expected_stjet'+points[0][0]+'_${version}.txt')
plot_obs.write_txt('cls_limits_observed_stjet'+points[0][0]+'_${version}.txt')
...
report.write_html('htmlout_fourtopstjet'+points[0][0]+'_$version')
