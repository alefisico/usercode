...
def get_model():
    ...
    model = build_model_from_rootfile('/uscms/home/algomez/nobackup/files/fourtop/resultsTreeAnalyzer/results110/Nbjets3//BDTResponsev2/mu_disc700_templates.root', include_mc_uncertainties = True)
...
plot_exp.write_txt('bayesian_limits_expected_BDT'+points[0][0]+'_v2.txt')
plot_obs.write_txt('bayesian_limits_observed_BDT'+points[0][0]+'_v2.txt')
#plot_exp.write_txt('cls_limits_expected_BDT'+points[0][0]+'_v2.txt')
#plot_obs.write_txt('cls_limits_observed_BDT'+points[0][0]+'_v2.txt')
...
report.write_html('htmlout_fourtopBDT'+points[0][0]+'_v2')
