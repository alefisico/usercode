...
if not options.useData :
    ...
    process.source.fileNames = [
        '/store/user/algomez/st2_h_bb_st1_bj_250_100_AOD/st2_h_bb_st1_bj_250_100_AOD_10_1_3xv.root',
 '/store/user/algomez/st2_h_bb_st1_bj_250_100_AOD/st2_h_bb_st1_bj_250_100_AOD_11_1_JEx.root',
 '/store/user/algomez/st2_h_bb_st1_bj_250_100_AOD/st2_h_bb_st1_bj_250_100_AOD_12_1_Xdk.root',
 '/store/user/algomez/st2_h_bb_st1_bj_250_100_AOD/st2_h_bb_st1_bj_250_100_AOD_13_1_nxt.root',
 '/store/user/algomez/st2_h_bb_st1_bj_250_100_AOD/st2_h_bb_st1_bj_250_100_AOD_14_1_rV0.root',
 '/store/user/algomez/st2_h_bb_st1_bj_250_100_AOD/st2_h_bb_st1_bj_250_100_AOD_15_1_WdR.root',
 '/store/user/algomez/st2_h_bb_st1_bj_250_100_AOD/st2_h_bb_st1_bj_250_100_AOD_16_1_R6M.root',
 '/store/user/algomez/st2_h_bb_st1_bj_250_100_AOD/st2_h_bb_st1_bj_250_100_AOD_17_1_QDe.root',
 '/store/user/algomez/st2_h_bb_st1_bj_250_100_AOD/st2_h_bb_st1_bj_250_100_AOD_18_1_Prt.root',
 '/store/user/algomez/st2_h_bb_st1_bj_250_100_AOD/st2_h_bb_st1_bj_250_100_AOD_19_1_jSu.root',
 '/store/user/algomez/st2_h_bb_st1_bj_250_100_AOD/st2_h_bb_st1_bj_250_100_AOD_1_1_h0W.root',
 '/store/user/algomez/st2_h_bb_st1_bj_250_100_AOD/st2_h_bb_st1_bj_250_100_AOD_20_1_KMi.root',
 '/store/user/algomez/st2_h_bb_st1_bj_250_100_AOD/st2_h_bb_st1_bj_250_100_AOD_2_1_4al.root',
 '/store/user/algomez/st2_h_bb_st1_bj_250_100_AOD/st2_h_bb_st1_bj_250_100_AOD_3_1_6z4.root',
 '/store/user/algomez/st2_h_bb_st1_bj_250_100_AOD/st2_h_bb_st1_bj_250_100_AOD_4_1_dE9.root',
 '/store/user/algomez/st2_h_bb_st1_bj_250_100_AOD/st2_h_bb_st1_bj_250_100_AOD_5_1_HZK.root',
 '/store/user/algomez/st2_h_bb_st1_bj_250_100_AOD/st2_h_bb_st1_bj_250_100_AOD_6_1_f6a.root',
 '/store/user/algomez/st2_h_bb_st1_bj_250_100_AOD/st2_h_bb_st1_bj_250_100_AOD_7_1_O7S.root',
 '/store/user/algomez/st2_h_bb_st1_bj_250_100_AOD/st2_h_bb_st1_bj_250_100_AOD_8_1_ykb.root',
 '/store/user/algomez/st2_h_bb_st1_bj_250_100_AOD/st2_h_bb_st1_bj_250_100_AOD_9_1_fyg.root'
    ]
...
if options.useData :
    if options.writeFat :
        process.out.fileName = cms.untracked.string('st2_h_bb_st1_bj_250_100_'+options.tlbsmTag + '_data_fat.root')
    else :
        process.out.fileName = cms.untracked.string('st2_h_bb_st1_bj_250_100_'+options.tlbsmTag + '_data.root')
else :
    if options.writeFat :
        process.out.fileName = cms.untracked.string(options.tlbsmTag + '_mc_fat.root')
    else :
        process.out.fileName = cms.untracked.string('st2_h_bb_st1_bj_250_100_'+options.tlbsmTag + '_mc.root')
        #process.out.fileName = cms.untracked.string('/eos/uscms/store/user/algomez/Stops/PATTuples/st2_h_bb_st1_bj_250_100/st2_h_bb_st1_bj_250_100_'+options.tlbsmTag + '_mc.root')
...
open('st2_h_bb_st1_bj_250_100_junk.py','w').write(process.dumpPython())
